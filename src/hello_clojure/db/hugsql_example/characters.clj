(ns hello-clojure.db.hugsql-example.characters
...
(hugsql/def-db-fns "hello_clojure/db/sql/characters.sql")
...
(hugsql/def-sqlvec-fns "hello_clojure/db/sql/characters.sql")
