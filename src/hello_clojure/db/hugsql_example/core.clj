(ns hello-clojure.db.hugsql-example.core
  (:require [hello-clojure.db.hugsql-example.db :refer [db]]
            [hello-clojure.db.hugsql-example.characters :as characters]
            [hello-clojure.db.hugsql-example.quotes :as quotes]
